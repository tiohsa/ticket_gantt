Redmine::Plugin.register :ticket_gantt do
  ...
  project_module :ticket_gantt do
    ...
    permission :view_ticket_gantt, ticket_gantts: [:index, :add_ticket, :update_ticket, :delete_ticket, :add_relation, :update_relation, :delete_relation, :statuses, :trackers, :priorities], public: true
